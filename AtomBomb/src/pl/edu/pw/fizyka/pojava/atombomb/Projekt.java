	...
	private void initialize() {
		...
		ActionListener UstawDaneListener = new ActionListener(){
			public void actionPerformed(ActionEvent e){
				...
				JOptionPane.showMessageDialog(frame, "Ze wzglêdu na ograniczenie masy (masa krytyczna uranu 235 to oko³o 52 kg) znacz¹co zosta³ zwiêkszony przekrój czynny atomu.", null, JOptionPane.INFORMATION_MESSAGE);
			}
		};
